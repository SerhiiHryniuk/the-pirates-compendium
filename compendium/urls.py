...
from compendium.views import IndexView, SkillListView, SkillCreateView, SkillDetailView, SkillUpdateView, \
    ...
    DevilFruitPdfView, MonsterPdfView, ScenarioPdfView, SkillSearchView, DevilFruitSearchView, MonsterSearchView, \
    ScenarioSearchView
...
urlpatterns = [
    ...
    path("devil-fruit/search/", DevilFruitSearchView.as_view(), name="devil_fruit_search"),
    ...
    path("monster/search/", MonsterSearchView.as_view(), name="monster_search"),
    ...
    path("scenario/search/", ScenarioSearchView.as_view(), name="scenario_search"),
